package org.firstinspires.ftc.teamcode.auto.autos.blueAutos.old; // make sure this aligns with class location
...
public class PlanA_Blue extends NextFTCOpMode {
...
//    private final Pose pickup3Pose = new Pose(49, 135, Math.toRadians(0)); // Lowest (Third Set) of Artifacts from the Spike Mark.
    ...
    public void buildPaths() {
        ...
        scorePreloadFar = new Path(new BezierLine(startPoseFar, scorePoseFar));
        scorePreloadFar.setLinearHeadingInterpolation(startPoseFar.getHeading(), scorePoseFar.getHeading());
