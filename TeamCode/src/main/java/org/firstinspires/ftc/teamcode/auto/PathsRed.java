...
public class PathsRed {
    ...
    private final Pose startPoseClose = new Pose(111, 135.3, Math.toRadians(0)); // Start Pose of our robot for the close position.
    private final Pose startPoseFar = new Pose(74.5, 8, Math.toRadians(0)); // Start Pose of our robot for the far position.
